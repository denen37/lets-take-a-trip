    ...
    return (
        <Popover
            ...
            content={({ position, childRect, popoverRect }) => (
                ...
                >
                    <div className='flex flex-col items-center max-w-[450px] bg-white border border-gray-300 rounded-lg p-2 shadow-xl overflow-y-scroll'>
        ...
        >
            <div className='bg-orange-600 rounded-full p-1.5 cursor-pointer'
