...
const InstagramSocialCard = () => {
    const girls_blow_bubbles = '/images/Learn/girls-blowing-bubbles.png'
    ...
    return (
        <div className='bg-gray-50 p-4 rounded-xl relative w-full'>
            <div className='bg-gray-50 rounded-xl p-2 w-[50px] absolute right-0 top-0'>
                <img src={images.instagram} alt='' className='w-full' />
            </div>
            <img src={girls_blow_bubbles} alt='' />
            <div className='mt-4'>
                <div className='flex justify-between items-start'>
                    <div className='flex items-center gap-1'>
                        <img src={images.user} alt='' className='w-[50px] aspect-square rounded-full' />
                        <div>
                    ...
                    <div className='flex gap-1 bg-gradient-to-b from-purple-700 to-orange-500 py-1 px-2 rounded-md cursor-pointer'>
                        <img src={images.follow} alt='' className='w-[15px] aspect-square' />
